...
if ( $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if( ! $problems ) {
        ...
        try {
            ...
            redirect( 'categories.php', [ 'success' => 'category succesfully saved'] );
...
<main class="container w-auto mx-auto md:w-1/2 flex justify-center flex-col items-center p-5">
    <form class="w-full grid" action="category.php?id=<?= $id ?? '' ?>" method="POST">
        ...
        <div class="p-4">
            ...
            <textarea
                    class="blovk p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
